...
/* ============================================================
 * BEACON REPORT TRANSMISSION
 *
 * Forward declaration because parse_c_beacon()
 * is located before the function implementation.
 * ============================================================ */

static int send_beacon_report(uint16_t beacon_node_id,
                              uint16_t sequence,
                              int8_t rssi);
 ...
 *     BEACON_REPORT
 *
 * B is primarily transmitting BEACON_REPORT.
 * PING reception remains available for the existing test.
 * ============================================================ */
    ...
    const bt_addr_le_t *addr)
{
    ...
    /* --------------------------------------------------------
     * Forward beacon information through Bluetooth Mesh
     *
     * Payload:
     *
     * Byte 0-1 : Beacon Node ID
     * Byte 2-3 : Sequence
     * Byte 4   : RSSI
     * -------------------------------------------------------- */

    (void)send_beacon_report(
        node_id,
        sequence,
        rssi
    );
...
/* ============================================================
 * SEND BEACON REPORT THROUGH MESH
 *
 * Destination:
 *     A nRF5340 = 0x0001
 *
    ...
    int8_t rssi)
{
    ...
    /* --------------------------------------------------------
     * Send through Mesh Vendor Model
     * -------------------------------------------------------- */
